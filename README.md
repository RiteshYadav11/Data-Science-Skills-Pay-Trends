...
# Project 2 : DATA SCIENCE SKILLS & PAY TRENDS
...
- I first used Power Query to extract the original data (`Project_Analysis.xlsx`) and create two queries:
...
- Then, I transformed each query by changing column types, removing unnecessary columns, cleaning text to eliminate specific words, and trimming excess whitespace.
    ...
    - 🛠️ data_job_skills
        ...
        ![Project_Analysis_Screenshot2.png](Images/Project_Analysis_Screenshot2.png)  ![Project_Analysis_Screenshot2(1).png](Images/Project_Analysis_Screenshot2(1).png)
...
- ☁️ Emerging technologies like AWS and Azure also show significant presence, underlining the industry's shift towards cloud services and big data technologies.
    ...
    ![Project_Analysis_Chart3.png](Images/Project_Analysis_Chart3.png)
